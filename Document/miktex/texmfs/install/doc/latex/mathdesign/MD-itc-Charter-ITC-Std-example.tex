...
\title{Example of the \textsf{mdici} fonts.}

\author{Paul Pichaureau}


\usepackage[cal=scr,mdici,greekfamily = didot]{mathdesign}
%% \usepackage{amssymb}
...
\begin{abstract}
    The package \textsf{mdici} consists of a full set of
    mathematical fonts, designed to be combined with Itc
    Charter Itc Std as the main text font.
