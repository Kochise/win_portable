...
#define INTERNET_FLAG_BGUPDATE  0x00000008  /*undoc*/

#define SECURITY_INTERNET_MASK  (INTERNET_FLAG_IGNORE_CERT_CN_INVALID|INTERNET_FLAG_IGNORE_CERT_DATE_INVALID| \
                                 INTERNET_FLAG_IGNORE_REDIRECT_TO_HTTPS|INTERNET_FLAG_IGNORE_REDIRECT_TO_HTTP)

#define SECURITY_IGNORE_ERROR_MASK  (INTERNET_FLAG_IGNORE_CERT_CN_INVALID|INTERNET_FLAG_IGNORE_CERT_DATE_INVALID| \
...
#define INTERNET_FLAGS_MASK  (INTERNET_FLAG_RELOAD|INTERNET_FLAG_RAW_DATA|INTERNET_FLAG_EXISTING_CONNECT|\
                              ...
                              INTERNET_FLAG_PRAGMA_NOCACHE|INTERNET_FLAG_CACHE_ASYNC|INTERNET_FLAG_FORMS_SUBMIT|\
                              INTERNET_FLAG_NEED_FILE|INTERNET_FLAG_RESTRICTED_ZONE|INTERNET_FLAG_TRANSFER_BINARY|\
...
#define SECURITY_SET_MASK  (SECURITY_FLAG_IGNORE_REVOCATION|SECURITY_FLAG_IGNORE_UNKNOWN_CA|\
                            SECURITY_FLAG_IGNORE_CERT_CN_INVALID|SECURITY_FLAG_IGNORE_CERT_DATE_INVALID|\
                            SECURITY_FLAG_IGNORE_WRONG_USAGE|SECURITY_FLAG_IGNORE_WEAK_SIGNATURE)
...
#define GOPHER_TYPE_FILE_MASK  (GOPHER_TYPE_TEXT_FILE|GOPHER_TYPE_MAC_BINHEX|GOPHER_TYPE_DOS_ARCHIVE|\
                                ...
                                GOPHER_TYPE_SOUND|GOPHER_TYPE_HTML|GOPHER_TYPE_PDF|GOPHER_TYPE_CALENDAR|\
                                GOPHER_TYPE_INLINE)
...
typedef BOOL(CALLBACK *pfnInternetDeInitializeAutoProxyDll)(LPSTR, DWORD dwReserved);
...
BOOLAPI InternetReadFileExA(HINTERNET,LPINTERNET_BUFFERSA,DWORD,DWORD_PTR);
BOOLAPI InternetReadFileExW(HINTERNET,LPINTERNET_BUFFERSW,DWORD,DWORD_PTR);
INTERNETAPI_(DWORD) InternetSetFilePointer(HINTERNET,LONG,PVOID,DWORD,DWORD_PTR);
...
BOOLAPI HttpSendRequestExA(HINTERNET,LPINTERNET_BUFFERSA,LPINTERNET_BUFFERSA,DWORD,DWORD_PTR);
BOOLAPI HttpSendRequestExW(HINTERNET,LPINTERNET_BUFFERSW,LPINTERNET_BUFFERSW,DWORD,DWORD_PTR);
BOOLAPI HttpEndRequestA(HINTERNET,LPINTERNET_BUFFERSA,DWORD,DWORD_PTR);
BOOLAPI HttpEndRequestW(HINTERNET,LPINTERNET_BUFFERSW,DWORD,DWORD_PTR);
...
INTERNETAPI_(VOID) InternetFreeCookies(INTERNET_COOKIE2 *,DWORD);
INTERNETAPI_(DWORD) InternetGetCookieEx2(PCWSTR,PCWSTR,DWORD,INTERNET_COOKIE2 **,PDWORD);
INTERNETAPI_(DWORD) InternetSetCookieEx2(PCWSTR,const INTERNET_COOKIE2 *,PCWSTR,DWORD,PDWORD);
...
INTERNETAPI_(DWORD) InternetHangUp(DWORD,DWORD);
BOOLAPI InternetGoOnlineA(LPSTR,HWND,DWORD);
BOOLAPI InternetGoOnlineW(LPWSTR,HWND,DWORD);
BOOLAPI InternetAutodial(DWORD,HWND);
BOOLAPI InternetAutodialHangup(DWORD);
BOOLAPI InternetGetConnectedState(LPDWORD,DWORD);
BOOLAPI InternetGetConnectedStateExA(LPDWORD,LPSTR,DWORD,DWORD);
BOOLAPI InternetGetConnectedStateExW(LPDWORD,LPWSTR,DWORD,DWORD);
BOOLAPI DeleteWpadCacheForNetworks(WPAD_CACHE_DELETE);
BOOLAPI InternetInitializeAutoProxyDll(DWORD);
BOOLAPI DetectAutoProxyUrl(PSTR,DWORD,DWORD);
BOOLAPI CreateMD5SSOHash(PWSTR,PWSTR,PWSTR,PBYTE);
BOOLAPI InternetSetDialStateA(LPCSTR,DWORD,DWORD);
BOOLAPI InternetSetDialStateW(LPCWSTR,DWORD,DWORD);
...
INTERNETAPI_(DWORD) HttpIsHostHstsEnabled(PCWSTR,PBOOL);
