...
LONG __cdecl _InterlockedXor(LONG volatile *, LONG);
LONG64 __cdecl _InterlockedAnd64(LONG64 volatile *, LONG64);
LONG64 __cdecl _InterlockedOr64(LONG64 volatile *, LONG64);
LONG64 __cdecl _InterlockedXor64(LONG64 volatile *, LONG64);
...
LONG64 __cdecl _InterlockedCompareExchange64(LONG64 volatile *, LONG64, LONG64);
BOOLEAN __cdecl _InterlockedCompareExchange128(LONG64 volatile *, LONG64, LONG64, LONG64 *);
PVOID __cdecl _InterlockedCompareExchangePointer(PVOID volatile *, PVOID, PVOID);
PVOID __cdecl _InterlockedExchangePointer(PVOID volatile *, PVOID);
...
CHAR __cdecl _InterlockedExchange8(CHAR volatile *, CHAR);
...
char __cdecl _InterlockedExchangeAdd8(char volatile *, char);
char __cdecl _InterlockedAnd8(char volatile *, char);
char __cdecl _InterlockedOr8(char volatile *, char);
char __cdecl _InterlockedXor8(char volatile *, char);
SHORT __cdecl _InterlockedAnd16(SHORT volatile *, SHORT);
SHORT __cdecl _InterlockedOr16(SHORT volatile *, SHORT);
SHORT __cdecl _InterlockedXor16(SHORT volatile *, SHORT);
