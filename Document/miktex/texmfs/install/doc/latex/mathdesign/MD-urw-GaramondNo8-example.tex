...
\title{Example of the \textsf{mdugm} fonts.}

\author{Paul Pichaureau}


\usepackage[cal=scr,mdugm,greekfamily = didot]{mathdesign}
%% \usepackage{amssymb}
...
\begin{abstract}
    The package \textsf{mdugm} consists of a full set of
    mathematical fonts, designed to be combined with Urw
    Garamondno8 as the main text font.
