...
typedef /*__callback*/ DWORD(CALLBACK *PCM_NOTIFY_CALLBACK)(HCMNOTIFICATION, PVOID, CM_NOTIFY_ACTION, PCM_NOTIFY_EVENT_DATA, DWORD);
...
CMAPI CONFIGRET WINAPI CM_Detect_Resource_Conflict_Ex(DEVINST dnDevInst, RESOURCEID ResourceID, PCVOID ResourceData, ULONG ResourceLen, PBOOL pbConflictDetected,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Disable_DevNode(DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Disable_DevNode_Ex(DEVINST dnDevInst,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Enable_DevNode_Ex(DEVINST dnDevInst,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Enumerate_Classes(ULONG ulClassIndex, LPGUID ClassGuid, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Enumerate_Classes_Ex(ULONG ulClassIndex, LPGUID ClassGuid,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Enumerate_EnumeratorsA(ULONG ulEnumIndex, PSTR Buffer, PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Enumerate_EnumeratorsW(ULONG ulEnumIndex, PWSTR Buffer, PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Enumerate_Enumerators_ExA(ULONG ulEnumIndex, PSTR Buffer, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Enumerate_Enumerators_ExW(ULONG ulEnumIndex, PWSTR Buffer, PULONG pulLength,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Free_Log_Conf_Ex(LOG_CONF lcLogConfToBeFreed,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Free_Res_Des_Ex(PRES_DES prdResDes, RES_DES rdResDes,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_Child_Ex(PDEVINST pdnDevInst, DEVINST dnDevInst,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Class_NameA(LPGUID ClassGuid, PSTR Buffer, PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Class_NameW(LPGUID ClassGuid, PWSTR Buffer, PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Class_Name_ExA(LPGUID ClassGuid, PSTR Buffer, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Class_Name_ExW(LPGUID ClassGuid, PWSTR Buffer, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_NameA(LPGUID ClassGuid, LPSTR pszKeyName, PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_NameW(LPGUID ClassGuid,LPWSTR, PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_Name_ExA(LPGUID ClassGuid, LPSTR pszKeyName, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_Name_ExW(LPGUID ClassGuid,LPWSTR, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Depth(PULONG pulDepth, DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Depth_Ex(PULONG pulDepth, DEVINST dnDevInst,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_IDA(DEVINST dnDevInst, PSTR Buffer, ULONG BufferLen, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_IDW(DEVINST dnDevInst, PWSTR Buffer, ULONG BufferLen, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ExA(DEVINST dnDevInst, PSTR Buffer, ULONG BufferLen,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ExW(DEVINST dnDevInst, PWSTR Buffer, ULONG BufferLen,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_ExA(PCSTR pszFilter, PCHAR Buffer, ULONG BufferLen,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_ExW(PCWSTR pszFilter, PWCHAR Buffer, ULONG BufferLen,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_Size_ExA(PULONG pulLen, PCSTR pszFilter,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_Size_ExW(PULONG pulLen, PCWSTR pszFilter,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_Size(PULONG pulLen, DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_Size_Ex(PULONG pulLen, DEVINST dnDevInst,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Registry_Property_ExA(DEVINST dnDevInst, ULONG ulProperty, PULONG pulRegDataType, PVOID Buffer, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Registry_Property_ExW(DEVINST dnDevInst, ULONG ulProperty, PULONG pulRegDataType, PVOID Buffer, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Status(PULONG pulStatus, PULONG pulProblemNumber, DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Status_Ex(PULONG pulStatus, PULONG pulProblemNumber, DEVINST dnDevInst,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_First_Log_Conf(PLOG_CONF plcLogConf, DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_First_Log_Conf_Ex(PLOG_CONF plcLogConf, DEVINST dnDevInst,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Global_State(PULONG pulState, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Global_State_Ex(PULONG pulState,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Hardware_Profile_InfoA(ULONG ulIndex, PHWPROFILEINFO_A pHWProfileInfo, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Hardware_Profile_Info_ExA(ULONG ulIndex, PHWPROFILEINFO_A pHWProfileInfo,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Hardware_Profile_InfoW(ULONG ulIndex, PHWPROFILEINFO_W pHWProfileInfo, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Hardware_Profile_Info_ExW(ULONG ulIndex, PHWPROFILEINFO_W pHWProfileInfo,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_FlagsA(DEVINSTID_A pDeviceID, ULONG ulHardwareProfile, PULONG pulValue, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_FlagsW(DEVINSTID_W pDeviceID, ULONG ulHardwareProfile, PULONG pulValue, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_Flags_ExA(DEVINSTID_A pDeviceID, ULONG ulHardwareProfile, PULONG pulValue,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_Flags_ExW(DEVINSTID_W pDeviceID, ULONG ulHardwareProfile, PULONG pulValue,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Alias_ExA(LPCSTR pszDeviceInterface, LPGUID AliasInterfaceGuid, LPSTR pszAliasDeviceInterface, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Alias_ExW(LPCWSTR pszDeviceInterface, LPGUID AliasInterfaceGuid, LPWSTR pszAliasDeviceInterface, PULONG pulLength,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_List_ExA(LPGUID InterfaceClassGuid, DEVINSTID_A pDeviceID, PCHAR Buffer, ULONG BufferLen,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_List_ExW(LPGUID InterfaceClassGuid, DEVINSTID_W pDeviceID, PWCHAR Buffer, ULONG BufferLen,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_List_Size_ExA(PULONG pulLen, LPGUID InterfaceClassGuid, DEVINSTID_A pDeviceID,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_List_Size_ExW(PULONG pulLen, LPGUID InterfaceClassGuid, DEVINSTID_W pDeviceID,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Log_Conf_Priority(LOG_CONF lcLogConf, PPRIORITY pPriority, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Log_Conf_Priority_Ex(LOG_CONF lcLogConf, PPRIORITY pPriority,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Next_Log_Conf(PLOG_CONF plcLogConf, LOG_CONF lcLogConf, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Next_Log_Conf_Ex(PLOG_CONF plcLogConf, LOG_CONF lcLogConf,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Parent(PDEVINST pdnDevInst, DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Parent_Ex(PDEVINST pdnDevInst, DEVINST dnDevInst,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data(RES_DES rdResDes, PVOID Buffer, ULONG BufferLen, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data_Ex(RES_DES rdResDes, PVOID Buffer, ULONG BufferLen,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data_Size(PULONG pulSize, RES_DES rdResDes, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data_Size_Ex(PULONG pulSize, RES_DES rdResDes,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Sibling(PDEVINST pdnDevInst, DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Sibling_Ex(PDEVINST pdnDevInst, DEVINST dnDevInst,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Locate_DevNode_ExA(PDEVINST pdnDevInst, DEVINSTID_A pDeviceID,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Locate_DevNode_ExW(PDEVINST pdnDevInst, DEVINSTID_W pDeviceID,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Modify_Res_Des_Ex(PRES_DES prdResDes, RES_DES rdResDes, RESOURCEID ResourceID, PCVOID ResourceData, ULONG ResourceLen,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Move_DevNode(DEVINST dnFromDevInst, DEVINST dnToDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Move_DevNode_Ex(DEVINST dnFromDevInst, DEVINST dnToDevInst,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_Next_Res_Des_Ex(PRES_DES prdResDes, RES_DES rdResDes, RESOURCEID ForResource, PRESOURCEID pResourceID,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Open_Class_Key_ExA(LPGUID ClassGuid, LPCSTR pszClassName, REGSAM samDesired, REGDISPOSITION Disposition, PHKEY phkClass,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Open_Class_Key_ExW(LPGUID ClassGuid, LPCWSTR pszClassName, REGSAM samDesired, REGDISPOSITION Disposition, PHKEY phkClass,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Open_DevNode_Key_Ex(DEVINST dnDevNode, REGSAM samDesired, ULONG ulHardwareProfile, REGDISPOSITION Disposition, PHKEY phkDevice,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Data_Ex(PVOID pData, ULONG DataLen, DEVINST dnDevInst, RESOURCEID ResourceID,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Size_Ex(PULONG pulSize, DEVINST dnDevInst, RESOURCEID ResourceID,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Query_Remove_SubTree(DEVINST dnAncestor, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Query_Remove_SubTree_Ex(DEVINST dnAncestor,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Query_And_Remove_SubTree_ExA(DEVINST dnAncestor, PPNP_VETO_TYPE pVetoType, LPSTR pszVetoName, ULONG ulNameLength,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Query_And_Remove_SubTree_ExW(DEVINST dnAncestor, PPNP_VETO_TYPE pVetoType, LPWSTR pszVetoName, ULONG ulNameLength,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Request_Device_Eject_ExA(DEVINST dnDevInst, PPNP_VETO_TYPE pVetoType, LPSTR pszVetoName, ULONG ulNameLength,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Request_Device_Eject_ExW(DEVINST dnDevInst, PPNP_VETO_TYPE pVetoType, LPWSTR pszVetoName, ULONG ulNameLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Reenumerate_DevNode(DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Reenumerate_DevNode_Ex(DEVINST dnDevInst,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Register_Device_Interface_ExA(DEVINST dnDevInst, LPGUID InterfaceClassGuid, LPCSTR pszReference, LPSTR pszDeviceInterface, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Register_Device_Interface_ExW(DEVINST dnDevInst, LPGUID InterfaceClassGuid, LPCWSTR pszReference, LPWSTR pszDeviceInterface, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Problem_Ex(DEVINST dnDevInst, ULONG ulProblem,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Unregister_Device_Interface_ExA(LPCSTR pszDeviceInterface,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Unregister_Device_Interface_ExW(LPCWSTR pszDeviceInterface,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Register_Device_Driver(DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Register_Device_Driver_Ex(DEVINST dnDevInst,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Remove_SubTree(DEVINST dnAncestor, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Remove_SubTree_Ex(DEVINST dnAncestor,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Registry_Property_ExA(DEVINST dnDevInst, ULONG ulProperty, PCVOID Buffer, ULONG ulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Registry_Property_ExW(DEVINST dnDevInst, ULONG ulProperty, PCVOID Buffer, ULONG ulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Is_Dock_Station_Present(PBOOL pbPresent);
CMAPI CONFIGRET WINAPI CM_Is_Dock_Station_Present_Ex(PBOOL pbPresent,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Request_Eject_PC(VOID);
CMAPI CONFIGRET WINAPI CM_Request_Eject_PC_Ex(HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_FlagsA(DEVINSTID_A pDeviceID, ULONG ulConfig, ULONG ulValue, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_FlagsW(DEVINSTID_W pDeviceID, ULONG ulConfig, ULONG ulValue, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Flags_ExA(DEVINSTID_A pDeviceID, ULONG ulConfig, ULONG ulValue,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Flags_ExW(DEVINSTID_W pDeviceID, ULONG ulConfig, ULONG ulValue,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Setup_DevNode(DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Setup_DevNode_Ex(DEVINST dnDevInst,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Uninstall_DevNode(DEVNODE dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Uninstall_DevNode_Ex(DEVNODE dnDevInst,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Run_Detection(ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Run_Detection_Ex(ULONG ulFlags,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof(ULONG ulHardwareProfile, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Ex(ULONG ulHardwareProfile,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Query_Resource_Conflict_List(PCONFLICT_LIST pclConflictList, DEVINST dnDevInst, RESOURCEID ResourceID, PCVOID ResourceData, ULONG ResourceLen,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Registry_PropertyW(LPGUID ClassGuid, ULONG ulProperty, PULONG pulRegDataType, PVOID Buffer, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Set_Class_Registry_PropertyW(LPGUID ClassGuid, ULONG ulProperty, PCVOID Buffer, ULONG ulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Class_Registry_PropertyA(LPGUID ClassGuid, ULONG ulProperty, PULONG pulRegDataType, PVOID Buffer, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Set_Class_Registry_PropertyA(LPGUID ClassGuid, ULONG ulProperty, PCVOID Buffer, ULONG ulLength,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Custom_Property_ExA(DEVINST dnDevInst, PCSTR pszCustomPropertyName, PULONG pulRegDataType, PVOID Buffer, PULONG pulLength,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Custom_Property_ExW(DEVINST dnDevInst, PCWSTR pszCustomPropertyName, PULONG pulRegDataType, PVOID Buffer, PULONG pulLength,ULONG,HMACHINE);
...
DWORD WINAPI CM_WaitNoPendingInstallEvents(DWORD);
...
CMAPI CONFIGRET WINAPI CM_Open_Device_Interface_Key_ExA(LPCSTR pszDeviceInterface, REGSAM samDesired, REGDISPOSITION Disposition, PHKEY phkDeviceInterface,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Open_Device_Interface_Key_ExW(LPCWSTR pszDeviceInterface, REGSAM samDesired, REGDISPOSITION Disposition, PHKEY phkDeviceInterface,ULONG,HMACHINE);
...
CMAPI CONFIGRET WINAPI CM_Delete_Device_Interface_Key_ExA(LPCSTR pszDeviceInterface,ULONG,HMACHINE);
CMAPI CONFIGRET WINAPI CM_Delete_Device_Interface_Key_ExW(LPCWSTR pszDeviceInterface,ULONG,HMACHINE);
