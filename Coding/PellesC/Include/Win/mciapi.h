...
WINMMAPI MCIERROR WINAPI mciSendStringW(LPCWSTR lpstrCommand, LPWSTR, UINT, HWND);
...
DWORD_PTR APIENTRY mciGetDriverData(MCIDEVICEID);
UINT APIENTRY mciLoadCommandResource(HANDLE, LPCWSTR, UINT);
BOOL APIENTRY mciSetDriverData(MCIDEVICEID, DWORD_PTR);
UINT APIENTRY mciDriverYield(MCIDEVICEID);
