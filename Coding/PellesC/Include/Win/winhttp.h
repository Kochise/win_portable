...
WINHTTPAPI DWORD WINAPI WinHttpWebSocketSend(HINTERNET, WINHTTP_WEB_SOCKET_BUFFER_TYPE, PVOID, DWORD);
WINHTTPAPI DWORD WINAPI WinHttpWebSocketReceive(HINTERNET, PVOID, DWORD, DWORD *, WINHTTP_WEB_SOCKET_BUFFER_TYPE *);
WINHTTPAPI DWORD WINAPI WinHttpWebSocketShutdown(HINTERNET, USHORT, PVOID, DWORD);
WINHTTPAPI DWORD WINAPI WinHttpWebSocketClose(HINTERNET, USHORT, PVOID, DWORD);
WINHTTPAPI DWORD WINAPI WinHttpWebSocketQueryCloseStatus(HINTERNET, USHORT *, PVOID, DWORD, DWORD *);
