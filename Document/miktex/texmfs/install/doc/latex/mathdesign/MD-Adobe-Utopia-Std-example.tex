...
\title{Example of the \textsf{mdpus} fonts.}

\author{Paul Pichaureau}


\usepackage[cal=scr,mdpus,greekfamily = didot]{mathdesign}
%% \usepackage{amssymb}
...
\begin{abstract}
    The package \textsf{mdpus} consists of a full set of
    mathematical fonts, designed to be combined with Adobe
    Utopia Std as the main text font.
